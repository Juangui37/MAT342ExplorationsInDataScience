...
#We're going to change this to numeric
...
imputed_Data <- mice(region_NA, m=5, maxit = 50, method = 'pmm', seed = 89)
...
fit <- with(data = college_type_NA, lm(Starting_Median_Salary +
                                      ...
                                      Mid_Career_90th_percentile_Salary ~ School_Type))
